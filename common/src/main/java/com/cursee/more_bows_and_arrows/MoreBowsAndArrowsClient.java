...
//        ItemProperties.register(item, new Identifier("pull"), ((itemStack, clientLevel, livingEntity, i) -> {
...
//        }));
        ItemProperties.register(item, Identifier.withDefaultNamespace("pull"), ((itemStack, clientLevel, livingEntity, i) -> {
            if (livingEntity == null || livingEntity.getUseItem() != itemStack) return 0.0f;
        ...
        ItemProperties.register(item, Identifier.withDefaultNamespace("pulling"), ((itemStack, clientLevel, livingEntity, i) -> {
